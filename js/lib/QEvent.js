...
*		QEvent.remove		- dettach event.. you know
*		QEvent.fire			- fire event
*
*		QEvent.addOnce		- event listener will be removed after first call
*		QEvent.toggle		- attach or dettach by fourth parametr
*
*		QEvent.addDom		- attach DOM event listener, 
*		QEvent.removeDom	- dettach DOM event listener
*
...
var QEvent = window.events = (function() {
...
(function() {
	...
	QEvent.DomEvents.mouseover = QEvent.DomEvents.mouseenter;
	QEvent.DomEvents.mouseout = QEvent.DomEvents.mouseleave;
